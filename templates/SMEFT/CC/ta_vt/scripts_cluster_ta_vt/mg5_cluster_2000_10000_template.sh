...
SCRIPTS_PATH='/disk/data11/ttp/faroughy/Flavor_at_LHC/ta_vt/SMEFT/'
PROC='scripts_SMEFT_ta_vt_2000_10000'
DELPHES_CARD=/disk/data11/ttp/faroughy/Flavor_at_LHC/mono-tau/SMEFT/cards/delphes_card_ATLAS_monotau.dat
...
for MG5_SCRIPT in $SCRIPTS_PATH/$PROC/* ; do
  ...
  echo 'cp /scratch/$USER/$SLURM_JOB_ID/*/*/*/Events/*/*.lhco.gz /disk/data11/ttp/faroughy/Flavor_at_LHC/ta_vt/SMEFT/lhco_files/' >> $SCRIPT.slurm
