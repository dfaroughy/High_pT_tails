...
SCRIPTS_PATH='/disk/data11/ttp/faroughy/Flavor_at_LHC/_RUN_/SMEFT/'
PROC='scripts_SMEFT__RUN___XMIN___XMAX_'
DELPHES_CARD=_DELPHES_CARD_PATH_
...
for MG5_SCRIPT in $SCRIPTS_PATH/$PROC/* ; do
  ...
  echo 'cp /scratch/$USER/$SLURM_JOB_ID/*/*/*/Events/*/*.lhco.gz /disk/data11/ttp/faroughy/Flavor_at_LHC/_RUN_/SMEFT/lhco_files/' >> $SCRIPT.slurm
