...
SCRIPTS_PATH='/disk/data11/ttp/faroughy/Flavor_at_LHC/mu_vm/SMEFT/'
PROC='scripts_SMEFT_mu_vm_4000_15000'
DELPHES_CARD=/disk/data11/ttp/faroughy/Flavor_at_LHC/mu_vm/SMEFT/cards/delphes_card_mono-lepton.dat
...
for MG5_SCRIPT in $SCRIPTS_PATH/$PROC/* ; do
  ...
  echo 'cp /scratch/$USER/$SLURM_JOB_ID/*/*/*/Events/*/*.lhco.gz /disk/data11/ttp/faroughy/Flavor_at_LHC/mu_vm/SMEFT/lhco_files/' >> $SCRIPT.slurm
